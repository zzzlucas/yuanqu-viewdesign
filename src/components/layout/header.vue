<template>
  <div class="herder">
    <div class="herder-left">
      <ul class="menu">
        <li>
          <img class="logo" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3615831237,1510664097&fm=26&gp=0.jpg"/>
        </li>
        <li>
          <router-link to="/">
            其他园区
        ...
        <li class="information-box" v-on:mouseenter="showInformationMenu" v-on:mouseleave="hideInformationMenu">
          <a href="javascript:void(0)">
            资讯
          </a>
          <div class="information-menu" v-show="informationMenuShow">
            ...
            <ul>
              <li @click="goRouter('MessageIndex')">通知公告</li>
              <li @click="goRouter('MessageIndex')">新闻动态</li>
    ...
    <div class="herder-right">
      ...
      <router-link to="/" class="right-icon"><i class="iconfont iconxiaoxi"></i> </router-link>
      <router-link to="/" class="right-icon"><i class="iconfont iconshezhi"></i> </router-link>
