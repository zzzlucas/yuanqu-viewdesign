<template>
  <div class="enterprises-record-step1">
    ...
    <div class="enterprises-record-form">
      <p class="title">基本信息</p>
      <div class="enterprises-record-form-body">
        <div class="form-box">
        ...
        <div class="form-box">
          ...
          <div class="form-radio">
            ...
            <div class="form-box">
              <p>表格下载链接：<span style="color: red;">施工企业备案登记表.docx</span></p>
            </div>
...
export default {
  ...
  methods: {
    next () {
      this.$router.push({name: 'EnterprisesRecordStep2'})
    },
    handleView (name) {
      this.imgName = name
      this.visible = true
