    ...
    <div class="rubbish-disposition-form">
      ...
      <div class="rubbish-disposition-form-body">
        <div class="form-box">
          <Row :gutter="36">
            <Col span="12">
              <p class=""><span class="must">* </span> 填报单位：</p>
              <div class="form-radio">
                <Input v-model="form.unit"/>
              </div>
            </Col>
            <Col span="12">
              <p class=""><span class="must">* </span> 填报日期：</p>
              <div class="form-radio">
        ...
        <div class="form-box">
          <Row :gutter="36">
            <Col span="12">
              <p class=""><span class="must">* </span> 产品名称：</p>
              <div class="form-radio">
                <Input v-model="form.productName"/>
              </div>
            </Col>
            <Col span="12">
              <p class=""><span class="must">* </span> 行业类别：</p>
              <div class="form-radio">
        ...
        <div class="form-box">
          <Row :gutter="36">
            <Col span="12">
              <p class=""><span class="must">* </span> 建设地址：</p>
              <div class="form-radio">
                <Input v-model="form.architecture"/>
              </div>
            </Col>
            <Col span="12">
              <p class=""><span class="must">* </span> 所属主体：</p>
              <div class="form-radio">
        ...
        <div class="form-box">
          <Row :gutter="36">
            <Col span="12">
              <p class=""><span class="must">* </span> 法人代表：</p>
              <div class="form-radio">
                <Input v-model="form.legalPerson"/>
              </div>
            </Col>
            <Col span="12">
              <p class=""><span class="must">* </span> 联系电话（法人）：</p>
              <div class="form-radio">
                <Input v-model="form.legalPersonPhone"/>
              </div>
            </Col>
          </Row>
        </div>
        <div class="form-box">
          <Row :gutter="36">
            ...
            <Col span="12">
              <p class=""><span class="must">* </span>联系电话（经办人）：</p>
              <div class="form-radio">
                <Input v-model="form.agentPhone"/>
              </div>
            </Col>
          </Row>
        </div>
        <div class="form-box">
          <p class=""><span class="must">*</span> 公司概况：</p>
          <div class="form-radio">
            <Input v-model="form.survey" type="textarea" :rows="5" />
          </div>
        </div>
        <div class="form-box">
          <p class=""><span class="must">*</span> 团队成员情况：</p>
          <div class="form-radio">
            <Input v-model="form.membersSituation" type="textarea" :rows="5" />
          </div>
        </div>
        <div class="form-box">
          <Row :gutter="36">
            <Col span="12">
              <p class=""><span class="must">* </span> 年产值(万元)：</p>
              <div class="form-radio">
                <Input v-model="form.annualOutputValue"/>
              </div>
            </Col>
            <Col span="12">
              <p class=""><span class="must">* </span>年税金(万元)：</p>
              <div class="form-radio">
        ...
        <div class="form-box">
          <p class=""><span class="must">*</span> 投资主体：</p>
          <div class="form-radio">
            <Select v-model="form.investmentSubject" style="width:200px">
              <Option v-for="item in investmentSubjectList" :value="item.value" :key="item.value">{{ item.label }}</Option>
            </Select>
          </div>
        </div>
        <div class="form-box">
          <p class=""><span class="must">*</span> 是否人才项目：</p>
          <div class="form-radio">
    ...
    <p class="title">投资情况</p>
     <div class="rubbish-disposition-form-body">
      <div class="form-box">
        <Row :gutter="36">
          <Col span="12">
            <p class=""><span class="must">* </span> 总投资（万元）：</p>
            <div class="form-radio">
              <Input v-model="form.totalInvestment"/>
            </div>
          </Col>
          <Col span="12">
            <p class=""><span class="must">* </span> 注册资本(万元)：</p>
            <div class="form-radio">
      ...
      <div class="form-box">
        <Row :gutter="36">
          <Col span="12">
            <p class=""><span class="must">* </span> 是否外资：</p>
            <div class="form-radio">
      ...
      <div class="form-box">
        <Row :gutter="36">
          ...
          <Col span="12">
            <p class=""><span class="must">* </span> 租赁面积（m²）：</p>
            <div class="form-radio">
      ...
      <div class="form-box">
        <Row :gutter="36">
          ...
          <Col span="12">
            <p class=""><span class="must">* </span> 单位面积固定资产投资（万元/平方米）：</p>
            <div class="form-radio">
              <Input v-model="form.industryType"/>
            </div>
          </Col>
